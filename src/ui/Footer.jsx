...
function Footer() {
  return (
    <footer className="bg-[#EAECF6] mt-4">
      <div className="max-w-7xl mx-auto p-4 md:p-10 xl:px-0 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-10">
        ...
        <div className="w-full">
          ...
          <ul className="flex flex-col gap-2 text-sm">
            <li>E-mail: mengsrun@computertopia.store</li>
